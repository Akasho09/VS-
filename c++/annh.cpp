...
int main()
{
        int colSizeA, rowSizeA;
    
    // Get the dimensions of the A matrix from the user
    std::cout << "Enter the number of columns/variables for matrix A: ";
    std::cin >> colSizeA;
    std::cout << "Enter the number of rows/constraints for matrix A: ";
    std::cin >> rowSizeA;
    ...
    for (int i = 0; i < rowSizeA; i++) {
        ...
        // Get values for vector B from the user
    std::cout << "Enter the values for vector B:" << std::endl;
    for (int i = 0; i < rowSizeA; i++) {
        std::cout << "Enter B[" << i << "]: ";
        std::cin >> B[i];
    }
    
    // Get values for vector C from the user
    std::cout << "Enter the values for vector C:" << std::endl;
    for (int i = 0; i < colSizeA; i++) {
        std::cout << "Enter C[" << i << "]: ";
        std::cin >> C[i];
    }
    
    // Create the Simplex object and calculate the simplex
